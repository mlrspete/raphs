...
const offers = [
  {
    ...
    note: "Try out Monroes for 12 hours. Browse the members market and decide whether you want to go Monroes Ultra.",
    bullets: ["Members market preview", "12-hour look inside Monroes", "One-time purchase, no hidden fees"],
  ...
  },
  {
    ...
    note: "Ongoing access to the Monroes members market.",
